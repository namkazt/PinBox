...
typedef struct PacketLinkList {
	AVPacket* refPacket = nullptr;
	PacketLinkList* prev = nullptr;
	PacketLinkList* next = nullptr;
}PacketLinkList;
...
private:
	...
	PacketLinkList*												m_packet;
	PacketLinkList*												m_lastPacket;
